...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-20 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Welkom bij De Bazaar</h2>
  </div>
    ...
    <form class="space-y-6" action="#" method="POST">
      ...
      <div>
        <div class="flex items-center justify-between">
          <label for="password" class="block text-sm/6 font-medium text-gray-900">Wacthwoord</label>
          <div class="text-sm">
            <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Wacthwoord vergeten?</a>
          </div>
        </div>
        <div class="mt-2">
      ...
      <div>
        <button type="submit" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Inloggen</button>
      </div>
    </form>

    <p class="mt-10 text-center text-sm/6 text-gray-500">
      Nog geen account?
      <a href="{{ route('show.register') }}" class="font-semibold text-indigo-600 hover:text-indigo-500">Maak een account aan</a>
    </p>
  </div>
</div> 
</body>
